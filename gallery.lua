...
-- 📌 **NFT Collection Data**
local nftData = {
    {name = "Xolo NFT 1", image = "rbxassetid://109838897698977", price = 100, description = "Primer NFT de la colección."},
    {name = "Xolo NFT 2", image = "rbxassetid://127729753396080", price = 150, description = "Segundo NFT en exhibición."},
    {name = "Xolo NFT 3", image = "rbxassetid://137732748422823", price = 200, description = "Tercer NFT exclusivo de XolosArmy."},
    {name = "Xolo NFT 4", image = "rbxassetid://127944492837842", price = 250, description = "Cuarto NFT único de la colección."},
    {name = "Xolo NFT 5", image = "rbxassetid://106152825339854", price = 300, description = "Quinto NFT con historia especial."},
    {name = "Xolo NFT 6", image = "rbxassetid://115836311466595", price = 350, description = "NFT final en la galería de XolosArmy."}
}
